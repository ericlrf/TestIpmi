...
//                            System.out.println(rec.);
                            ...
                            System.out.println(rec.getLowerNonCriticalThreshold());
                            System.out.println(rec.getUpperNonCriticalThreshold());
                            System.out.println(rec.getUpperCriticalThreshold());
                            System.out.println(rec.getUpperNonRecoverableThreshold());
                            System.out.println(rec.isThresholdsReadable());
                            System.out.println("-----------------------");
                        }
                        if (record instanceof CompactSensorRecord) {
                            ...
                            System.out.println(rec.isHysteresisReadable());
...
//                    	System.out.println(">>> Sensores desativados: "+count++);
//                        e.printStackTrace();
                    } else {
                        throw e;
                    }
